		...
		<div className="relative min-h-[90vh] flex items-center justify-center py-16 overflow-hidden w-full">
			...
			<div className="w-full max-w-7xl mx-auto px-6 relative z-10">
				...
				<div className="relative pb-12">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
							...
							<div className="flex flex-col gap-2">
								...
								<input
									...
									style={
										!formData.startDate ? { color: "rgb(156, 163, 175)" } : {}
									}
								/>
								{errors.startDate && (
									<p className="text-red-600 text-xs font-semibold bg-red-50 px-2 py-1 rounded-md">
						...
						{showAdvanced && (
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 pt-8 border-t-2 border-blue-200">
								<div>
									...
									/>
									{errors.budget && (
										<p className="text-red-600 text-sm font-semibold bg-red-50 px-3 py-1.5 rounded-lg mt-1">
											{errors.budget}
										</p>
									)}
								</div>
					...
					<div className="absolute left-1/2 -translate-x-1/2 -bottom-0 z-10 add-bottom-padding">
						<Button
							onClick={onGenerateTrips}
							disabled={loading}
							className="px-12 py-5 text-lg rounded-full font-bold shadow-2xl hover:shadow-orange-400/50 transition-all duration-300 bg-[#E67E22] hover:bg-[#D35400] text-white border-0 transform hover:scale-105"
						>
