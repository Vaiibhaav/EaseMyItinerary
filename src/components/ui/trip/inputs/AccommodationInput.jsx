	...
	return (
		<div className="flex flex-col gap-2">
			...
			>
				...
				<option value="hotel" style={{ color: "var(--foreground)" }}>
					Hotel
				</option>
				<option value="hostel" style={{ color: "var(--foreground)" }}>
					Hostel
				</option>
				<option value="airbnb" style={{ color: "var(--foreground)" }}>
					Airbnb
				</option>
				<option value="guesthouse" style={{ color: "var(--foreground)" }}>
					Guesthouse
				</option>
				<option value="na" style={{ color: "var(--foreground)" }}>
					Not applicable
				</option>
			</select>
		</div>
